//? Server Sent Events, EventSourse
//* Встроенный класс EventSourse
// позволяет поддерживать соедиенение с сервером и получать от него события
// встроенное переподключение
// В отличие от WebSocket соединения EventSourse:
...
//* Получение сообщений
// const eventSourse = new EventSourse(url [, {options}])
...
// Как и fetch, EventSourse поддерживает запросы на другие домены
...
// Если браузер хочет разорвать соединение, то должен вызвать eventSourse.close()
...
//    установит его значение в eventSourse.lastEventId
