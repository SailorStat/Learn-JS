...
//* Только строки
// Ключ и значение только строки
// Если мы используем другое значение, то оно будет преобразовано в строку
// Чтобы хранить большие объекты, нужно использовать JSON


//* sessionStorage
// Вкладки не общаются
//    Ифреймы общаются
// Если вкладка закрыта, данные удаляются


//* Событие storage
// При обновлении localStorage и sessionStorage генерируется событие storage со свойствами
//    key - ключ, который обновился
//    oldValue - старое значение
//    newValue - новое значение
//    url - url документа, где произошло обновление
//    storageArea - объект, где произошло обновление
// событие срабатывает только в других окнах сайта